...
e20 <- import("~/Dropbox/PSCI107/Final Project/Data/2020-11-03.RDS")

e20 <- e20$cnty

# So, I am actually going to drop meta from here on out. It does not have info that I can use, except potentially
# number of registered voters and total votes. However, I will just calculate total votes from the D + R and run with
# it, cause that is what you would do with Trussler's OG cleaned dataset anyways.
